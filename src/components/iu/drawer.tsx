...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={joinClasses("fixed inset-0 z-50 bg-black/50", className)}
      {...props}
    />
  );
}
  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full bg-gray-200 data-[vaul-drawer-direction=bottom]:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
...
function DrawerHeader({
  ...
  return (
    <div
      ...
      className={joinClasses("flex flex-col gap-1.5 p-4", className)}
      {...props}
    />
  );
}
...
function DrawerFooter({
  ...
  return (
    <div
      ...
      className={joinClasses("mt-auto flex flex-col gap-2 p-4", className)}
      {...props}
    />
  );
}
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={joinClasses("font-semibold text-gray-900", className)}
      {...props}
    />
  );
}
